...
public class Client_Manage {
    ...
    public Client_Manage(String id, String name, String status, String bonus) {
        this.id = id;
        this.name = name;
        this.status = status;
        this.bonus = bonus;
    ...
    public static Pane getPane(Pane pane, ScrollPane scrollPane) throws SQLException, FileNotFoundException, ClassNotFoundException {
        ...
        for(int i=0; i<mas.length;i++, u+=70){
            ...
            pane.getChildren().addAll(edit,description_text, price_text, DATA, num_text, pos);
        }
    ...
    public static void change(Pane pane, String id, ScrollPane scrollPane) throws SQLException, FileNotFoundException {
        ...
        save.setOnAction(x ->{
            ...
            if(t1.isEmpty())
                ...
                try {
                    DataBase.UpdateClient(id, t1, t2, t3);
                    Pane p = Client_Manage.getPane(finalPane, scrollPane);
    ...
    public static void add(Pane pane,  ScrollPane scrollPane) throws SQLException, FileNotFoundException {
        ...
        Button save = new Button("Выйти и сохранить");
        save.setLayoutX(100);
        save.setLayoutY(250);
        ...
        save.setOnAction(x ->{
            ...
            if(t1.isEmpty())
                ...
                try {
                    ...
                    Pane p = Client_Manage.getPane(pane, scrollPane);
                    scrollPane.setContent(p);
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                } catch (FileNotFoundException e) {
    ...
    public static void print(Pane pane, ScrollPane scrollPane, String[][] mas) throws SQLException, FileNotFoundException {
        pane = new Pane();
        Pane res = pane;
        ...
        for(int i=0;i<mas[0].length;i++, u+=50) {
            ...
            pane.getChildren().addAll(description_text, price_text, DATA, num_text, edit,pos);
        }
        ...
        back.setOnAction(value ->{
            Pane pane1 = new Pane();
            try {
                pane1 = Client_Manage.getPane(pane2, scrollPane);
